...
namespace GirafAPI.Endpoints
{
    public static class OrganizationEndpoints
    {
        public static RouteGroupBuilder MapOrganizationEndpoints(this WebApplication app)
        {
            ...
            group.MapGet("/{id:int}", [Authorize] async (int id, UserManager<GirafUser> userManager, GirafDbContext dbContext, ClaimsPrincipal userClaims) =>
            {
                var userId = userClaims.FindFirstValue(ClaimTypes.NameIdentifier);
                if (userId == null)
                {
            ...
            group.MapPut("/{id:int}", [Authorize(Roles = "OrganizationAdmin")] async (int id, UpdateOrganizationDTO updateDTO, UserManager<GirafUser> userManager, GirafDbContext dbContext, ClaimsPrincipal userClaims) =>
            {
                var userId = userClaims.FindFirstValue(ClaimTypes.NameIdentifier);
                if (userId == null)
                {
                ...
                organization.UpdateFromDTO(updateDTO);
            ...
            group.MapDelete("/{id:int}", [Authorize(Roles = "OrganizationAdmin")] async (int id, UserManager<GirafUser> userManager, GirafDbContext dbContext, ClaimsPrincipal userClaims) =>
            {
                var userId = userClaims.FindFirstValue(ClaimTypes.NameIdentifier);
                if (userId == null)
                {
            ...
            group.MapPost("/{organizationId:int}/users", [Authorize(Roles = "OrganizationAdmin")] async (int organizationId, AddUserToOrganizationDTO dto, UserManager<GirafUser> userManager, GirafDbContext dbContext, ClaimsPrincipal userClaims) =>
            {
            ...
            group.MapDelete("/{organizationId:int}/users/{userId}", [Authorize(Roles = "OrganizationAdmin")] async (int organizationId, string userId, UserManager<GirafUser> userManager, GirafDbContext dbContext, ClaimsPrincipal userClaims) =>
            {
                var adminUserId = userClaims.FindFirstValue(ClaimTypes.NameIdentifier);
